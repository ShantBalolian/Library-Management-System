...
class CreateAccount:
    ...
    def __init__(self, root):
        ...
        path_to_left = "C:/Users/reals/OneDrive/Desktop/CPSPROJECT/bluewood.jpg"
    ...
    def create_account(self):
        ...
        # insert_query = """
        #     INSERT INTO PERSON
        #     VALUES('{1987/02/12}','sean123@gmail.com','6471123456', 'pas4s123', 's5ean','beasl1ey','Onta1rio','Toro1nto','Canada','214 Jane St.')
        # """.format(self.birthdate.get(), self.email.get(), self.phonenumber.get(), self.password.get(), self.first_name.get(), self.last_name.get(), self.province.get(), self.city.get(), self.country.get(), self.street.get())

        # insert_query = """
        #     INSERT INTO PERSON
        #     VALUES('1987/02/12','slowean123@gmail.com','6471123456', 'pas4s123', 's5ean','beasl1ey','Onta1rio','Toro1nto','Canada','214 Jane St.')
        #
        # """
        ...
        # create_account = """
        #     INSERT INTO PERSON
        #     VALUES('1987/02/12','jason@gmail.com','6471123456', 'pass123', 'sean','beasley','Ontario','Toronto','Canada','214 Jane')
        #     """
